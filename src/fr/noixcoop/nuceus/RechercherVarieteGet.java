...
public class RechercherVarieteGet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		sortie.println("<html><body><h1>Variete de noix inconnue</h1></body></html>");
		}
		else{
			response.setContentType("text/html");
			PrintWriter sortie = response.getWriter();
			sortie.println("<html><body><h1>Variete de noix : " + request.getParameter("variete")  +"</h1></body></html>");
